...
public class CourseDBManagerTest {
	...
	public void testShowAll() {
		...
		assertEquals(list.get(1),"Course:CMSC203 CRN:30504 Credits:4 Instructor:Joey Bag-O-Donuts Room:SC450");
		assertEquals(list.get(2),"Course:CMSC204 CRN:30559 Credits:4 Instructor:BillyBob Jones Room:SC450");
			}
	/**
