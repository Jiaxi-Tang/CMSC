...
public class NotationStackTest {
	...
	public void testPopStudent() {
		try {
			assertEquals(4.3, doubleS.pop(),0.001);
			assertEquals(3.2, doubleS.pop(),0.001);
			assertEquals(2.1, doubleS.pop(),0.001);
	...
	public void testPushStudent() {
		try {
			...
			assertEquals(true, doubleS.push(5.4));
	...
	public void testToStringStudent() {
		assertEquals("1.02.13.24.3", doubleS.toString());
		doubleS.push(5.4);
		assertEquals("1.0 2.1 3.2 4.3 5.4", doubleS.toString(" "));
	}
